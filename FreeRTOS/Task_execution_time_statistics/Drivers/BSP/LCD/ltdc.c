...
/**
 * @brief       LTDC,层颜窗口设置,窗口以LCD面板坐标系为基准
 ...
 * @param        M2:M1:M0
 * @param        0 :0 :0    //4.3寸480*272 RGB屏,ID=0X4342
 * @param        0 :0 :1    //7寸800*480 RGB屏,ID=0X7084
 * @param        0 :1 :0    //7寸1024*600 RGB屏,ID=0X7016
 * @param        0 :1 :1    //7寸1280*800 RGB屏,ID=0X7018
 * @param        1 :0 :0    //4.3寸800*480 RGB屏,ID=0X4384
